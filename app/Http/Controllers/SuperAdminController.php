    ...
    public function payment_settings()
{
    ...
    return view('superadmin.payment_credentials.payment_settings', [
        'paypal' => $paypal,
        'global_currency' => $global_currency,
        'global_currency_position' => $global_currency_position,
...
public function update_payment_settings(Request $request)
{
    ...
    return redirect()->route('superadmin.payment_settings')->with('message', 'Settings have been updated');
}
